...
class PMGeneratorGUI:
    def __init__(self, master: tk.Tk):
        ...
        # Top: OBJ selection
        # -------------------------------------------------------------------
        obj_frame = tk.LabelFrame(master, text="OBJ Source (Bodies + Wings)", fg=GROUP_LABEL_FG)
        ...
        # -------------------------------------------------------------------
        grp_frame = tk.LabelFrame(master, text="Detected Groups in OBJ", fg=GROUP_LABEL_FG)
        ...
        # -------------------------------------------------------------------
        mode_frame = tk.LabelFrame(master, text="ACF Mode", fg=GROUP_LABEL_FG)
        ...
        # -------------------------------------------------------------------
        new_frame = tk.LabelFrame(master, text="New Aircraft Options", fg=GROUP_LABEL_FG)
        ...
        # -------------------------------------------------------------------
        mod_frame = tk.LabelFrame(master, text="Modify Existing ACF", fg=GROUP_LABEL_FG)
        ...
        log_frame = tk.LabelFrame(master, text="Log", fg=GROUP_LABEL_FG)
    ...
    def apply_dark_theme(self):
        ...
        def style_widget(w):
            cls = w.winfo_class()
            try:
                if cls in ("Frame", "Labelframe", "TLabelframe"):
                    w.configure(bg=BG_FRAME)
                elif cls == "Label":
                    text = str(w.cget("text"))
                    fg = FG_TEXT if text else FG_SUBTLE
                    parent_bg = w.master.cget("bg") if "bg" in w.master.keys() else BG_FRAME
